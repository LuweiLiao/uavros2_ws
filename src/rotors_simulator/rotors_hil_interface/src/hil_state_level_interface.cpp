...
HilStateLevelInterface::HilStateLevelInterface(
    ...
    : HilInterface(node), hil_state_qtrn_msg_{} {
...
HilStateLevelInterface::CollectData() {
  ...
  const Eigen::Quaterniond att = q_S_B_ * hil_data_.att;
  ...
  hil_state_qtrn_msg_.xacc =
      acc.x() * kMetersToMm / kGravityMagnitude_m_per_s2;
  hil_state_qtrn_msg_.yacc =
      acc.y() * kMetersToMm / kGravityMagnitude_m_per_s2;
  hil_state_qtrn_msg_.zacc =
      acc.z() * kMetersToMm / kGravityMagnitude_m_per_s2;

  mavlink_msg_hil_state_quaternion_encode(1, 0, &mmsg,
                                           &hil_state_qtrn_msg_);

  mavros_msgs::msg::Mavlink rmsg_hil_state_qtrn;
  rmsg_hil_state_qtrn.header.stamp =
