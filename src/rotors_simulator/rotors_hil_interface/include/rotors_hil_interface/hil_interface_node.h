...
class HilInterfaceNode : public rclcpp::Node {
 public:
  HilInterfaceNode();
  ~HilInterfaceNode() override = default;
 ...
 private:
  ...
  rclcpp::Publisher<mav_msgs::msg::Actuators>::SharedPtr actuators_pub_;
  ...
  rclcpp::Subscription<mavros_msgs::msg::HilControls>::SharedPtr
      hil_controls_sub_;

  /// HIL loop frequency (Hz).
  double hil_frequency_{kDefaultHilFrequency};
