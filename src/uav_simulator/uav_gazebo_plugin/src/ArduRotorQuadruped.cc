...
GZ_REGISTER_MODEL_PLUGIN(ArduRotorQuadruped)
...
/////////////////////////////////////////////////
ArduRotorQuadruped::ArduRotorQuadruped()
...
/////////////////////////////////////////////////
void ArduRotorQuadruped::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    GZ_ASSERT(_model, "ArduRotorQuadruped _model pointer is null");
    GZ_ASSERT(_sdf, "ArduRotorQuadruped _sdf pointer is null");
    ...
    // iteration.
    this->dataPtr->updateConnection = event::Events::ConnectWorldUpdateBegin(std::bind(&ArduRotorQuadruped::OnUpdate, this));
...
/////////////////////////////////////////////////
void ArduRotorQuadruped::OnUpdate()
{
...
/////////////////////////////////////////////////
void ArduRotorQuadruped::ResetPIDs()
{
...
/////////////////////////////////////////////////
bool ArduRotorQuadruped::InitArduPilotSockets(sdf::ElementPtr _sdf) const
{
...
/////////////////////////////////////////////////
void ArduRotorQuadruped::ApplyMotorForces(const double _dt)
{
...
/////////////////////////////////////////////////
void ArduRotorQuadruped::ReceiveMotorCommand()
{
...
/////////////////////////////////////////////////
void ArduRotorQuadruped::SendState() const
{
    // send_fdm
    fdmPacket pkt;
