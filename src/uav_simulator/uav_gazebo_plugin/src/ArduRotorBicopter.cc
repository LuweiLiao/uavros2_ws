...
GZ_REGISTER_MODEL_PLUGIN(ArduRotorBicopter)
...
/////////////////////////////////////////////////
ArduRotorBicopter::ArduRotorBicopter()
...
/////////////////////////////////////////////////
void ArduRotorBicopter::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    GZ_ASSERT(_model, "ArduRotorBicopter _model pointer is null");
    GZ_ASSERT(_sdf, "ArduRotorBicopter _sdf pointer is null");
    ...
    // iteration.
    this->dataPtr->updateConnection = event::Events::ConnectWorldUpdateBegin(std::bind(&ArduRotorBicopter::OnUpdate, this));
...
/////////////////////////////////////////////////
void ArduRotorBicopter::OnUpdate()
{
...
/////////////////////////////////////////////////
void ArduRotorBicopter::ResetPIDs()
{
...
/////////////////////////////////////////////////
bool ArduRotorBicopter::InitArduPilotSockets(sdf::ElementPtr _sdf) const
{
...
/////////////////////////////////////////////////
void ArduRotorBicopter::ApplyMotorForces(const double _dt)
{
...
/////////////////////////////////////////////////
void ArduRotorBicopter::ReceiveMotorCommand()
{
...
/////////////////////////////////////////////////
void ArduRotorBicopter::SendState() const
{
    // send_fdm
    fdmPacket pkt;
