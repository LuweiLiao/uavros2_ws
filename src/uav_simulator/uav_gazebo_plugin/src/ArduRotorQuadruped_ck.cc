...
#include "ArduRotorQuadruped_ck.hh"
...
GZ_REGISTER_MODEL_PLUGIN(ArduRotorQuadruped_ck)
...
/////////////////////////////////////////////////
ArduRotorQuadruped_ck::ArduRotorQuadruped_ck()
...
/////////////////////////////////////////////////
void ArduRotorQuadruped_ck::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    GZ_ASSERT(_model, "ArduRotorQuadruped_ck _model pointer is null");
    GZ_ASSERT(_sdf, "ArduRotorQuadruped_ck _sdf pointer is null");
    ...
    // iteration.
    this->dataPtr->updateConnection = event::Events::ConnectWorldUpdateBegin(std::bind(&ArduRotorQuadruped_ck::OnUpdate, this));
...
/////////////////////////////////////////////////
void ArduRotorQuadruped_ck::OnUpdate()
{
...
/////////////////////////////////////////////////
void ArduRotorQuadruped_ck::ResetPIDs()
{
...
/////////////////////////////////////////////////
bool ArduRotorQuadruped_ck::InitArduPilotSockets(sdf::ElementPtr _sdf) const
{
...
/////////////////////////////////////////////////
void ArduRotorQuadruped_ck::ApplyMotorForces(const double _dt)
{
...
/////////////////////////////////////////////////
void ArduRotorQuadruped_ck::ReceiveMotorCommand()
{
...
/////////////////////////////////////////////////
void ArduRotorQuadruped_ck::SendState() const
{
    // send_fdm
    fdmPacket pkt;
