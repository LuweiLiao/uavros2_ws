...
#include "ArduRotorOctBoxPlugin.hh"
...
GZ_REGISTER_MODEL_PLUGIN(ArduRotorOctBoxPlugin)
...
/////////////////////////////////////////////////
ArduRotorOctBoxPlugin::ArduRotorOctBoxPlugin()
...
/////////////////////////////////////////////////
void ArduRotorOctBoxPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    GZ_ASSERT(_model, "ArduRotorOctBoxPlugin _model pointer is null");
    GZ_ASSERT(_sdf, "ArduRotorOctBoxPlugin _sdf pointer is null");
    ...
    this->dataPtr->updateConnection
        = event::Events::ConnectWorldUpdateBegin(std::bind(&ArduRotorOctBoxPlugin::OnUpdate, this));
...
/////////////////////////////////////////////////
void ArduRotorOctBoxPlugin::OnUpdate()
{
...
/////////////////////////////////////////////////
void ArduRotorOctBoxPlugin::ResetPIDs()
{
...
/////////////////////////////////////////////////
bool ArduRotorOctBoxPlugin::InitArduPilotSockets(sdf::ElementPtr _sdf) const
{
...
/////////////////////////////////////////////////
void ArduRotorOctBoxPlugin::ApplyMotorForces(const double _dt)
{
...
/////////////////////////////////////////////////
void ArduRotorOctBoxPlugin::ReceiveMotorCommand()
{
    ...
    if (recvSize == -1) {
        ...
        for (unsigned i = 0; i < this->dataPtr->motor_num; ++i) {
            if (i < MAX_MOTORS) {
                double cmd = ignition::math::clamp(pkt.motorSpeed[i], -1.0f, 1.0f);
...
/////////////////////////////////////////////////
void ArduRotorOctBoxPlugin::SendState() const
{
    // send_fdm
    fdmPacket pkt;
