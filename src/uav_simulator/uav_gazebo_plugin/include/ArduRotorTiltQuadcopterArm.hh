 ...
 *
*/
#ifndef GAZEBO_PLUGINS_ARDUPILOTTILTQUADCOPTER_ARM_HH_
#define GAZEBO_PLUGINS_ARDUPILOTTILTQUADCOPTER_ARM_HH_
...
class GAZEBO_VISIBLE ArduRotorTiltQuadcopterArm : public ModelPlugin {
    /// \brief Constructor.
public:
    ArduRotorTiltQuadcopterArm();
