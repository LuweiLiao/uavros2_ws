 ...
 *
*/
#ifndef GAZEBO_PLUGINS_ARDUPILOTPLUGIN_QUADRUPED_BICOPTER_HH_
#define GAZEBO_PLUGINS_ARDUPILOTPLUGIN_QUADRUPED_BICOPTER_HH_
...
class GAZEBO_VISIBLE ArduRotorQuadrupedBicopter : public ModelPlugin {
    /// \brief Constructor.
public:
    ArduRotorQuadrupedBicopter();
