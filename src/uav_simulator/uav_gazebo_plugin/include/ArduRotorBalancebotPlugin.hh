 ...
 *
*/
#ifndef GAZEBO_PLUGINS_Balance_HH_
#define GAZEBO_PLUGINS_Balance_HH_
...
class GAZEBO_VISIBLE ArduRotorBalancebotPlugin : public ModelPlugin {
    /// \brief Constructor.
public:
    ArduRotorBalancebotPlugin();
