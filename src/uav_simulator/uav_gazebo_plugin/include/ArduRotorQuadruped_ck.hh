 ...
 *
*/
#ifndef GAZEBO_PLUGINS_ARDUPILOTPLUGIN_QUADRUPED_CK_HH_
#define GAZEBO_PLUGINS_ARDUPILOTPLUGIN_QUADRUPED_CK_HH_
...
class GAZEBO_VISIBLE ArduRotorQuadruped_ck : public ModelPlugin {
    /// \brief Constructor.
public:
    ArduRotorQuadruped_ck();
