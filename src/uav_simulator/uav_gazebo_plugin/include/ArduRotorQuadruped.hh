 ...
 *
*/
#ifndef GAZEBO_PLUGINS_ARDUPILOTPLUGIN_QUADRUPED_HH_
#define GAZEBO_PLUGINS_ARDUPILOTPLUGIN_QUADRUPED_HH_
...
class GAZEBO_VISIBLE ArduRotorQuadruped : public ModelPlugin {
    /// \brief Constructor.
public:
    ArduRotorQuadruped();
