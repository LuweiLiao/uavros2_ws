 ...
 *
*/
#ifndef GAZEBO_PLUGINS_ARDUPILOTPLUGIN_BICOPTER_HH_
#define GAZEBO_PLUGINS_ARDUPILOTPLUGIN_BICOPTER_HH_
...
class GAZEBO_VISIBLE ArduRotorBicopter : public ModelPlugin {
    /// \brief Constructor.
public:
    ArduRotorBicopter();
